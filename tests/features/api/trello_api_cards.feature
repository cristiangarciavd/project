...
Feature: Cards Manager for Trello API
  ...
  @fixture_create_cards @api @fixture_delete_organizations @trellocards
  Scenario: Get a Card
  ...
  @fixture_create_lists @api @fixture_delete_organizations @trellocards
  ...
  @fixture_create_lists @api @fixture_delete_organizations @negative_test @trellocards
  ...
  @fixture_create_cards @api @fixture_delete_organizations @negative_test @trellocards
